...
export const mockServerFleet: ServerInstance[] = [
  {
    id: 'srv-prod-us-01',
    name: 'PostgreSQL Prod Principal (US-East)',
  ...
  {
    id: 'srv-prod-eu-02',
    name: 'PostgreSQL Prod Europa (EU-Central)',
  ...
  {
    id: 'srv-test-05',
    name: 'PostgreSQL Servidor de Testes QA',
    host: 'pg-test.internal.cloud',
    port: 5432,
    region: 'sa-east-1 (São Paulo)',
    environment: 'Teste',
    pgVersion: 'PostgreSQL 16.2',
    uptimeFormatted: '2d 04h 10m',
    cpuUsagePercent: 8,
    avgLatencyMs: 2.3,
    ...
    databases: [
      {
        datname: 'test_db_unit',
        sizeBytes: 11000000000,
        sizeFormatted: '11.3 GB',
        activeConnections: 3,
        maxConnections: 50,
        tps: 25,
        cacheHitRatio: 99.6,
